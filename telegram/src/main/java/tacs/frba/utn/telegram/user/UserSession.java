...
public class UserSession {
	...
	public enum SessionState {
		...
		FAVOURITES_ADD_AWAITING_FAV_ID,
		FAVOURITES_ADD_AWAITING_ID,
		FAVOURITES_REMOVE_AWAITING_ID_REPO,
		FAVOURITES_REMOVE_AWAITING_ID_FAV,
		...
		ADVANCED_SEARCH_AWAITING_QUERY,
		ADVANCED_SEARCH_AWAITING_NAME,
		ADVANCED_SEARCH_AWAITING_LANGUAGE,
		ADVANCED_SEARCH_AWAITING_SORT,
		ADVANCED_SEARCH_AWAITING_ORDER
